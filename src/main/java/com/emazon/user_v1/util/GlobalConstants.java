...
public class GlobalConstants {
    ...
    public static final boolean SUCCESS_LOGIN_STATUS = true;
    ...
    public static final String INVALID_USERNAME_LENGTH_MESSAGE = "Username must be between 1 and 255 characters";
